const Dashboard = () => {
    ...
    const timeSlots = ['8:00 - 9:30 AM', '9:30 - 11:00 AM', '11:00 - 12:30 PM','12:30 - 1:00 PM','1:00 - 2:30 PM'];
    ...
    return (
        <div>
            {/* Advised Courses */}
            <div className="p-4">
                <h2 className="text-2xl font-bold mb-4 text-center text-blue-600">Advised Courses</h2>
                    ...
                    <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                        ...
                        <tbody>
                            {courses.map((course, index) => (
                                <tr
                                    key={index}
                                    className={`${index % 2 === 0 ? 'bg-blue-100' : 'bg-blue-50'} hover:bg-blue-200`}
                                >
            ...
            {/* Course Schedule */}
            <div className="p-4">
                <h2 className="text-2xl font-bold mb-4 text-center text-blue-600">Course Schedule</h2>
                <div className="overflow-x-auto">
