            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                ...
                <form onSubmit={handleCreateCourse}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {/* Course Code */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="course_code">
                                Course Code
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Course Name */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="course_name">
                                Course Name
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Theory Room */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="theory_room">
                                Theory Room
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Theory Timing */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="theory_timing">
                                Theory Timing
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Lab Room */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="lab_room">
                                Lab Room
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Lab Timing */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="lab_timing">
                                Lab Timing
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Credit */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="credit">
                                Credit
                            </label>
                            <input
                                type="number"
