...
const FacultyGrade = () => {
    ...
    const handleGradeSubmit = async (e) => {
        e.preventDefault();
        const { email, course_code, credit, grade, semester, grade_point } = formData;

        try {
            const response = await fetch("http://your-backend-api.com/submit-grade", {
                method: "POST",
                headers: {
            ...
            <div className="mt-6 bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                ...
                <form onSubmit={handleGradeSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Grade Point Field */}
                        <div>
                            <label className="block text-sm font-medium mb-2" htmlFor="grade_point">
                                Grade Point
                            </label>
                            <input
                                type="number"
